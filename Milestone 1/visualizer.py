joint_angles = (-4.095328761331626, 4.711421259704473, 2.1590171666943547) #Ex. (0,0,0)
env = 10 #index of env (0 - 20)
...
def create_environment(index):
    ...
    print(f"Obstacle Locations: {obstacle_positions}")
    obstacles = []
...
obstacles = create_environment(env)
print(obstacles)
